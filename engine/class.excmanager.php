    ...
    public function __construct(Exception $e, $s = null)
    {
        ...
        switch($eName)
        {
            ...
            case 'UserIsNotDostawca':
                if($s == 'comm') BFEC::add(BFEC::$e['PM']['UserIsNotDostawca_offer'], true, Pathes::getScriptIndexPath());
                else BFEC::add(BFEC::$e['PM']['UserIsNotDostawca'], true, Pathes::getScriptIndexPath());
            break;

            case 'UserIsNotKlient':
                if($s == 'comm') BFEC::add(BFEC::$e['PM']['UserIsNotKlient_join'], true, Pathes::getScriptIndexPath());
                else BFEC::add(BFEC::$e['PM']['UserIsNotKlient'], true, Pathes::getScriptIndexPath());
            break;
