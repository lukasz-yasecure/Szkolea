...
class ResultsListTemplate
{
    ...
    private $comms = false;
    private $servs = false;
    private $search_c = array('{%bgcolor1%}', '{%bgcolor2%}', '{%ikona%}', '{%kategoria%}', '{%tematyka%}', '{%id%}', '{%gdzie%}', '{%zapisanych%}', '{%cena_min%}', '{%cena_max%}', '{%pozostalo%}', '{%moduly%}', '{%status%}');
    ...
    public function addComm($b1, $b2, $ico, $kat, $tem, $id, $gdzie, $zapis, $c_min, $c_max, $pozo, $moduly, $status)
    {
        $this->comms = true;
        $this->replace[] = array($b1, $b2, $ico, $kat, $tem, $id, $gdzie, $zapis, $c_min, $c_max, $pozo, $moduly, $status);
    }
