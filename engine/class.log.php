...
class Log {
    ...
    public static function putLogMessage($name, $txt) {
        file_put_contents('logs/' . date('Ymd') . '_' . $name . '_msg.log', date('Y-m-d H:i:s') . ' ' . $txt . PHP_EOL, FILE_APPEND);
    }
    ...
    public static function cronTest($txt) {
