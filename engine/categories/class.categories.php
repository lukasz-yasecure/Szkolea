...
class Categories
{
    ...
    public function addK($k, $id, $act = false)
    {
        ...
        if($act) $this->kActId = count($this->kNames)-1;
    }

    public function getK()
    {
        if($this->kNr == count($this->kNames)) return null;
        else
        {
            $this->kNr++;
    ...
    {
        if($this->kNr-1 == $this->kActId) return true;
        else return false;
    }
    ...
    public function addO($k, $id, $act = false)
    {
        ...
        if($act) $this->oActId = count($this->oNames)-1;
    }

    public function getO()
    {
        if($this->oNr == count($this->oNames)) return null;
        else
        {
            $this->oNr++;
    ...
    {
        if($this->oNr-1 == $this->oActId) return true;
        else return false;
    }
    ...
    public function addT($k, $id, $act = false)
    {
        ...
        if($act) $this->tActId = count($this->tNames)-1;
    }

    public function getT()
    {
        if($this->tNr == count($this->tNames)) return null;
        else
        {
            $this->tNr++;
    ...
    {
        if($this->tNr-1 == $this->tActId) return true;
        else return false;
    }
    ...
    {
        if($this->mNr == count($this->mNames)) return null;
        else
        {
            $this->mNr++;
