...
class BFEC
{
    static $e = array(
        'PM' => array(
            'UserIsLogged' => 'nie mozesz byc zalogowany!',
            'UserIsNotLogged' => 'musisz sie zalogowac!',
            'UserIsNotKlient' => 'musisz posiadać konto typu "klient" zeby dodac zlecenie',
            'UserIsNotKlient_join' => 'musisz posiadać konto typu "klient" zeby wziac udzial w szkoleniu',
            'UserIsNotDostawca_offer' => 'musisz posiadać konto typu "dostawca" zeby dodac oferte',
            'UserIsNotDostawca' => 'musisz posiadać konto typu "dostawca" zeby dodac usluge'
        ),
        'UD' => array(
            ...
            'days_continuity' => 'Musisz wybrac preferowane dni po kolei, aby szkolenie odbylo sie bez przerw',
            'date' => 'Musisz podać poprawne daty',
            'date_long' => 'Musisz podać termin, w którym zmieści się szkolenie podanej długości!',
            'expire' => 'Waznosc szkolenia musi byc okreslona liczba wieksza od 0',
            ...
            'program' => 'Musisz podac poprawny program dla szkolenia!',
        ...
        'UM' => array(
            'InvalidUserValidation' => 'Nie pamiętasz hasła? <a href="remind.php">Poproś o nowe</a>.',
