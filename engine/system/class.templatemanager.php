...
class TemplateManager {
    ...
    public function getResultsListTemplate(System $sys, Results $r) {
        if ($r->areCommisionsSet())
            $path = $sys->getResultsRowCommTemplatePath();
        else
            $path = $sys->getResultsRowServTemplatePath();
    ...
    public function getResultsListTemplateForProfile(System $sys, Results $r, $profile = null) {
        if (is_null($profile))
            ...
            $path = 'view/html/index_results_row_comm_profile_offer.html';
        else if ($profile == 'moje')
            $path = 'view/html/index_results_row_comm_profile_moje.html';
        else if ($profile == 'biore')
            $path = 'view/html/index_results_row_comm_profile_biore.html';
    ...
    public function getResultsTemplate(System $sys, ResultsListTemplate $rlt) {
        $path = '';
        if ($rlt->comms())
            $path = $sys->getResultsTableCommsTemplatePath();
        else
            $path = $sys->getResultsTableServsTemplatePath();
    ...
    public function getResultsTemplateForProfile(System $sys, ResultsListTemplate $rlt, $profile = null) {
        if (is_null($profile))
            $path = 'view/html/index_results_table_comms_profile.html';
        else if ($profile == 'offer')
            $path = 'view/html/index_results_table_comms_profile_offer.html';
        else if ($profile == 'moje')
            $path = 'view/html/index_results_table_comms_profile_moje.html';
        else if ($profile == 'biore')
            $path = 'view/html/index_results_table_comms_profile_biore.html';
     ...
     */
    public function getCommsListForAdmin(DBC $dbc) {
     ...
     * @return Template 
     */
    public function getOfferTemplate(Template $t, $r) {
        $t->addSearchReplace('id_ofe', $r['id_ofe']);
        $t->addSearchReplace('date_add', UF::timestamp2date($r['date_add']));
        ...
        $t->addSearchReplace('kawy', $a['kawa']);
        $t->addSearchReplace('ile_kaw', $r['ile_kaw']);
        $t->addSearchReplace('date_a', UF::timestamp2date($r['date_a']));
